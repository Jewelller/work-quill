...
public class VerifyAuthenticationProvider implements AuthenticationProvider {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        if (JwtTool.isJwsValid(token)) {
            ...
            Claims payload = parser.parseSignedClaims(refreshToken).getPayload();
            ...
            var userRolesOpt = Optional.ofNullable(roleMapper.selectList(Wrappers.lambdaQuery(Role.ofId(user.getUserId()))));
            ...
            var userInfo = user.getUserLoginRecord().getUserLoginInfoRecord(userRoles, TimeTool.getExpireTime(nowDate, JwtTool.tokenExpireDuration));
